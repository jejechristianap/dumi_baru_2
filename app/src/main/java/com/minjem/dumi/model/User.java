...
public class User {
    private int id, status_topup, saldo, saldo_max;
    private String
            nip,
            email,
            password,
    ...
    public User(int id, String nip, String email, String password, String noKtp, String namaLengkap, String agama, String jenisKelamin, String tempatLahir, String tanggalLahir, String statusKawin, String jumlahTanggungan, String title, String ketTitle, String inskerKerja, String statusRumah, String alamat, String rt, String rw, String propinsi, String kota, String kecamatan, String kelurahan, String kodePos, String statusHubungan, String namaPenanggung, String noKtpPenanggung, String namaIbu, String noTelp, String imageKtp, String imageSelfi, String imageProfile, int status_topup, int saldo, int saldo_max) {
        this.id = id;
        this.nip = nip;
        this.email = email;
