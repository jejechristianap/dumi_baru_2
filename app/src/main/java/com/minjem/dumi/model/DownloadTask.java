...
import com.minjem.dumi.BuildConfig;
        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    alertDialogBuilder.setTitle("Format Dokumen  ");
                    alertDialogBuilder.setMessage("Dokumen berhasil di unduh ");
                    alertDialogBuilder.setCancelable(false);
                    alertDialogBuilder.setPositiveButton("tutup", (dialog, id) -> {

                    });

                    alertDialogBuilder.setNegativeButton("Buka Dokumen", (dialog, id) -> {
